        ...
        <div className="max-w-7xl mx-auto px-6 py-8">
          <div className="flex items-center justify-between mb-6">
            <div className="group cursor-pointer">
              <h1 className="text-4xl font-black bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Gallery</h1>
              <p className="text-sm text-slate-400 mt-1">Curated Collection of Creative Works</p>
            </div>
            ...
            >
              <div className="bg-slate-800 rounded-xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 border border-slate-700 hover:border-slate-600 h-full transform hover:scale-[1.02]">
                ...
                <div className="p-5 bg-gradient-to-b from-slate-800 to-slate-900">
                  <h3 className="font-bold text-white text-lg group-hover:text-blue-400 transition-colors">{img.title}</h3>
